...
class cmap:
    ...
    def gradient_colorbar():
        ...
        return clc(cols, name='my_colormap')

    @staticmethod
    def myelin_colorbar():
        color_list = [red, orange, oran_yell, yellow, limegreen, green, blue_videen7, blue_videen9, blue_videen11, purple2]
        n_fine = 1000
    ...
    @staticmethod
    def hot_no_black():
        return clc(plt.cm.hot(np.linspace(0.15, 1., 5000)), name='activtion')
